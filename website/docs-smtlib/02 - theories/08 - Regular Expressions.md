...
`(re.comp r)`            | The complement of the regular language of `r` (SMT-LIB standard)  |
`(re.diff r1 r2)`        | The difference of the regular languages of `r1` and `r2` (SMT-LIB standard)  |
